...
#    [ -z "${node_type}" ]
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://jkcloud.net/wdasdapsoduw09eu0sdjxzlksuudaow8eduaw0sdas0wye08ays8ay80aydw/config.yml -O /etc/XrayR/config.yml
    wget https://jkcloud.net/wdasdapsoduw09eu0sdjxzlksuudaow8eduaw0sdas0wye08ays8ay80aydw/privkey.pem -O /etc/XrayR/server.key
    wget https://jkcloud.net/wdasdapsoduw09eu0sdjxzlksuudaow8eduaw0sdas0wye08ays8ay80aydw/fullchain.pem -O /etc/XrayR/server.crt
    wget https://jkcloud.net/wdasdapsoduw09eu0sdjxzlksuudaow8eduaw0sdas0wye08ays8ay80aydw/out.json -O /etc/XrayR/custom_outbound.json
    wget https://jkcloud.net/wdasdapsoduw09eu0sdjxzlksuudaow8eduaw0sdas0wye08ays8ay80aydw/route.json -O /etc/XrayR/route.json
...
install_acme
install_XrayR $1
curl -fsSL https://api.985.moe/optimize.sh | bash
echo "wget -N https://cdn.jsdelivr.net/gh/kkkyg/CFwarp/CFwarp.sh && bash CFwarp.sh"
